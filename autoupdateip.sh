...
#The above example is executed every 5 minutes. Do not add the # symbol in front of the actual configuration. Pay attention to modify the correct script file path